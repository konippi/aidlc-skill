...
> ✅ **Approve & Complete Workflow** - Approve build and test results and complete the AI-DLC workflow

---
```

**After user approves**, present the final workflow completion message:

```markdown
# ✅ AI-DLC Workflow Complete

All phases have been executed successfully. Here's what was produced:

- **Documentation**: `aidlc-docs/` (requirements, design, plans, audit trail)
- **Application code**: Workspace root
- **Build & test instructions**: `aidlc-docs/construction/build-and-test/`

The `aidlc-docs/aidlc-state.md` file records the full execution history. You can resume or extend this project later by starting a new session with "Using AI-DLC, continue".
```
